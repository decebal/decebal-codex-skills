...
1. **Standalone skills** - Invoke with `$build-macos-apps` for guided development
...
2. Before creating PLAN.md, loads only relevant references from installed domain skill
...
### Plans Are Prompts
PLAN.md is the execution prompt. It contains objective, explicit context paths,
tasks (Files/Action/Verify/Done), and verification steps.
